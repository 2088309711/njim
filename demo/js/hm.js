(function () {
    var h = {}, mt = {}, c = {
        id: "b424d39312c46404f15e22574a531fbb",
        dm: ["amazeui.org"],
    ...
    mt.cookie.set = function (b, a, d) {
        var f;
        d.V && (f = new Date, f.setTime(f.getTime() + d.V));
        document.cookie = b + "=" + a + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (f ? "; expires=" + f.toGMTString() : "") + (d.Ib ? "; secure" : "")
    };
    ...
    mt.lang.C = function (b, a) {
        ...
        if (Array.prototype.indexOf) d = -1 !== b.indexOf(a); else for (var f = 0; f < b.length; f++) if (b[f] === a) {
            d = s;
            break
        }
        return d
    ...
    (function () {
        ...
        mt.e.Z = function (a, d) {
            ...
            if (!a) return g;
            for (; a.parentNode != t;) {
                for (var l = 0, n = 0, p = a.parentNode.childNodes.length, e = 0; e < p; e++) {
                    var k = a.parentNode.childNodes[e];
                    if (k.nodeName === a.nodeName && (l++, k === a && (n = l), 0 < n && 1 < l)) break
                }
                if ((p = "" !== a.id) && d) {
                    b.unshift("#" + encodeURIComponent(a.id));
                    break
                } else p && (p = "#" + encodeURIComponent(a.id), p = 0 < b.length ? p + ">" + b.join(">") : p, g.push(p)), b.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) +
                    (1 < l ? "[" + n + "]" : ""));
                a = a.parentNode
            }
            g.push(b.join(">"));
        ...
        mt.e.Cb = function (a) {
            var b = {top: 0, left: 0};
            if (!a) return b;
            var f = mt.e.Oa(a).documentElement;
            "undefined" !== typeof a.getBoundingClientRect && (b = a.getBoundingClientRect());
            return {
                top: b.top + (window.pageYOffset || f.scrollTop) - (f.clientTop || 0),
                left: b.left + (window.pageXOffset || f.scrollLeft) - (f.clientLeft || 0)
            }
        };
        mt.e.getAttribute = function (a, b) {
            var f = a.getAttribute && a.getAttribute(b) || t;
            if (!f && a.attributes && a.attributes.length) for (var g = a.attributes, l = g.length, n = 0; n < l; n++) g[n].nodeName === b && (f = g[n].nodeValue);
            return f
        };
        mt.e.J = function (a) {
            var b = "document";
        ...
        (function () {
            (mt.e.gb = function () {
                ...
                (function () {
                    if (!f) if (f = s, "complete" === document.readyState) a.M = s; else if (document.addEventListener) document.addEventListener("DOMContentLoaded", l, u), window.addEventListener("load", a, u); else if (document.attachEvent) {
    ...
    (function () {
        ...
        mt.g.ib = (window.screen.width || 0) + "x" + (window.screen.height || 0);
            ...
            switch (typeof d) {
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        var g = ["["], l = d.length, n, p, e;
                        for (p = 0; p < l; p++) switch (e = d[p], typeof e) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                            default:
                                n && g.push(","), g.push(mt.l.stringify(e)), n = 1
                        }
                        g.push("]");
                        return g.join("")
                    }
                    ...
                    n = ["{"];
                    p = mt.l.stringify;
                    for (l in d) if (Object.prototype.hasOwnProperty.call(d, l)) switch (e =
                        d[l], typeof e) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    mt.localStorage.set = function (b, a, d) {
        ...
        try {
            window.localStorage ? (a = f.getTime() + "|" + a, window.localStorage.setItem(b, a)) : mt.localStorage.P() && (mt.localStorage.i.expires = f.toUTCString(), mt.localStorage.i.load(document.location.hostname), mt.localStorage.i.setAttribute(b, a), mt.localStorage.i.save(document.location.hostname))
        } catch (g) {
        }
    };
    ...
    mt.localStorage.remove = function (b) {
        if (window.localStorage) window.localStorage.removeItem(b); else if (mt.localStorage.P()) try {
    ...
    mt.ha.Ab = function (b, a, d, f, g) {
        return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + b + '" width="' + d + '" height="' + f + '"><param name="movie" value="' + a + '" /><param name="flashvars" value="' + (g || "") + '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + b + '" width="' + d + '" height="' + f + '" src="' + a + '" flashvars="' + (g || "") + '" allowscriptaccess="always" /></object>'
    };
    mt.url = {};
    ...
    (function () {
        function b() {
            for (var a = u, b = document.getElementsByTagName("script"), f = b.length, f = 100 < f ? 100 : f, g = 0; g < f; g++) {
                var l = b[g].src;
    ...
    h.p = {
        ...
        xb: 1,
        da: 2147483647,
        ya: "kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn ct u tt".split(" "),
        D: s,
        na: ["a", "input", "button"],
        Ea: {
            id: "data-hm-id",
    ...
    (function () {
        var b = {
            r: {}, c: function (a, b) {
                ...
                this.r[a] = this.r[a] || [];
                for (var f = this.r[a].length, g = 0; g < f; g++) this.r[a][g](b)
            }
        };
        return h.A = b
    })();
    (function () {
        function b(b, f) {
            ...
            g.charset = "utf-8";
            a.d(f, "Function") && (g.readyState ? g.onreadystatechange = function () {
    ...
    (function () {
        var b = mt.lang, a = mt.e, d = mt.event, f = mt.g, g = h.p, l = h.A, n = +new Date, p = [], e = {
            oa: function () {
                return function (k) {
                    if (h.a && h.a.D && c.aet && c.aet.length) {
                        var d = k.target || k.srcElement;
                        if (d) {
                            var m = h.a.na, q = a.getAttribute(d, g.ma) != t ? s : u;
                            if (a.getAttribute(d, g.la) == t) if (q) e.Q(e.X(d, k)); else {
                                var f = a.J(d);
                                if (b.C(m, "*") || b.C(m, f)) e.Q(e.X(d, k)); else for (; d.parentNode != t;) {
                                    var q = d.parentNode, f = a.J(q), v = "a" === f && b.C(m, "a") ? s : u,
                                        f = "button" === f && b.C(m, "button") ? s : u,
                                        l = a.getAttribute(q, g.ma) != t ? s : u;
                                    if (a.getAttribute(q,
                                        g.la) == t && (v || f || l)) {
                                        e.Q(e.X(q, k));
                                        break
                ...
                m.S = a.getAttribute(k, q.S) || a.getAttribute(k, "class") || "";
                m.ka = a.getAttribute(k, q.ka) || a.Ta(k);
                m.content = a.getAttribute(k, q.content) || a.Pa(k);
                m.O = a.getAttribute(k, q.O) || a.J(k);
                m.link = a.getAttribute(k, q.link) || a.getAttribute(k, "href") || "";
                m.type = d.type || "click";
                q = b.ta(k.offsetTop) ? k.offsetTop : 0;
                "click" === d.type ? q = f.sa ? d.clientY + Math.max(document.documentElement.scrollTop,
                ...
                var d = b.j,
                    d = [+new Date - (h.a.s !== r ? h.a.s : n), d(a.id), d(a.S), d(a.O), d(a.ka), d(a.link), d(a.content), a.type, a.qb].join("*");
                e.R(d);
                b.C(["a"], a.O) && b.d(this.G(), "Function") && this.G()()
            }, R: function (a) {
                a.length > g.T || (encodeURIComponent(p.join("!") + a).length > g.T && (e.H(p.join("!")), p = []), p.push(a))
            }, H: function (a) {
                h.a.b.et =
                    5;
                h.a.b.ep = a;
        ...
        b.aa() && "" !== c.aet && l.c("pv-b", function () {
            ...
            d.c(window, "unload", e.G())
        });
        return e
    })();
    (function () {
        var b = mt.event, a = mt.g, d = h.p, f = h.A, g = +new Date, l = [], n = t, p = {
            Ia: function () {
                return function () {
                ...
                p.R([+new Date - (h.a.s !== r ? h.a.s : g), a].join("*"))
            }, R: function (a) {
                if (encodeURIComponent(l.join("!") + a).length > d.T || 5 < l.length) p.H(l.join("!")), l = [];
                l.push(a)
            }, H: function (b) {
                h.a.b.et = 6;
                h.a.b.vh = a.B();
                ...
                return function () {
                    l && l.length && (p.H(l.join("!")),
                        l = [])
                }
            }
        };
        mt.lang.aa() && "" !== c.aet && f.c("pv-b", function () {
            b.c(window, "scroll", p.Ia());
            b.c(window, "unload", p.G())
        });
        return p
    })();
    (function () {
        ...
        function a() {
            ...
            if ((!n || !e) && p && k) x = s, m = +new Date; else if (n && e && (!p || !k)) x = u, q += +new Date - m;
            n = p;
            e = k;
            z = setTimeout(a, 100)
        }
        ...
        function d(a) {
            var k = document, b = "";
            if (a in k) b = a; else for (var m = ["webkit", "ms", "moz", "o"], d = 0; d < m.length; d++) {
                var q = m[d] + a.charAt(0).toUpperCase() + a.slice(1);
                if (q in k) {
                    b =
                        q;
                    break
        ...
        var g = mt.event, l = h.A, n = s, p = s, e = s, k = s, w = +new Date, m = w, q = 0, x = s,
            v = d("visibilityState"), y = d("hidden"), z;
        a();
        (function () {
    ...
    (function () {
        var b = mt.lang, a = h.p, d = h.load, f = {
            eb: function (g) {
                if ((window._dxt === r || b.d(window._dxt, "Array")) && "undefined" !== typeof h.a) {
                    var f = h.a.W();
                    d([a.protocol, "//datax.baidu.com/x.js?si=", c.id, "&dm=", encodeURIComponent(f)].join(""), g)
                }
            }, pb: function (a) {
    ...
    (function () {
        function b(a, b, m, d) {
            if (!(a === r || b === r || d === r)) {
                if ("" === a) return [b, m, d].join("*");
                a = String(a).split("!");
                for (var e, f = u, g = 0; g < a.length; g++) if (e = a[g].split("*"), String(b) === e[0]) {
                    e[1] = m;
                    e[2] = d;
                    a[g] = e.join("*");
                    f = s;
        ...
        function a(b) {
            for (var e in b) if ({}.hasOwnProperty.call(b, e)) {
                var m = b[e];
                d.d(m, "Object") || d.d(m, "Array") ? a(m) : b[e] = String(m)
            }
        }

        var d = mt.lang, f = mt.l, g = mt.g, l = h.p, n = h.A, p = h.Ga, e = {
            F: [], N: 0, ua: u, o: {ia: "", page: ""}, init: function () {
                e.f =
                    0;
                n.c("pv-b", function () {
                    e.Ha();
                ...
                n.c("stag-b", function () {
                    h.a.b.api = e.f || e.N ? e.f + "_" + e.N : "";
                    h.a.b.ct = [decodeURIComponent(h.a.getData("Hm_ct_" + c.id) || ""), e.o.ia, e.o.page].join("!")
                });
                n.c("stag-d", function () {
                    h.a.b.api = 0;
                    e.f = 0;
                ...
                if (!a || d.d(a, "Array")) window._hmt = {
                    id: c.id, cmd: {}, push: function () {
                        for (var a = window._hmt, b = 0; b < arguments.length; b++) {
                            var k = arguments[b];
                            d.d(k, "Array") && (a.cmd[a.id].push(k), "_setAccount" ===
                ...
                var a = window._hmt;
                if (a && a.cmd && a.cmd[c.id]) for (var b = a.cmd[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, q = 0, f = b.length; q < f; q++) {
                    var g = b[q];
                    d.test(g[0]) ? e.F.push(g) : e.fa(g)
                }
                a.cmd[c.id] = {push: e.fa}
            }, La: function () {
                if (0 < e.F.length) for (var a = 0, b = e.F.length; a < b; a++) e.fa(e.F[a]);
                e.F = t
            }, fa: function (a) {
                var b = a[0];
                ...
                if (1 < a.length && (a = a[1], u === a || s === a)) e.f |= 2, h.a.qa = a
                ...
                if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                    ...
                    h.a.b.vl = g.K() + g.B();
                    h.a.b.kb = 0;
                    h.a.$ ? (h.a.b.nv = 0, h.a.b.st = 4) : h.a.$ = s;
                    var b = h.a.b.u, d = h.a.b.su;
                    h.a.b.u = l.protocol + "//" + document.location.host + a[1];
                    e.ua || (h.a.b.su = document.location.href);
                    h.a.h();
                    h.a.b.u = b;
                    h.a.b.su =
                        d;
                ...
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < m && 4 > m) {
                        ...
                        q[b - 1] = m + "*" + d.j(a[2]) + "*" + d.j(a[3]);
                        h.a.b.cv = q.join("!");
                        a = h.a.b.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                        "" !== a ? h.a.setData("Hm_cv_" +
                            c.id, encodeURIComponent(a), c.age) : h.a.hb("Hm_cv_" + c.id)
                    }
                }
                ...
                if (!(3 > a.length)) {
                    ...
                    a = d.j(a[2]);
                    if (e !== r && a !== r) {
                        var m = decodeURIComponent(h.a.getData("Hm_ct_" + c.id) || ""), m = b(m, e, 1, a);
                        h.a.setData("Hm_ct_" + c.id, encodeURIComponent(m), c.age)
                    }
                }
                ...
                1 < a.length && (h.a.b.su = a[1].charAt && "/" === a[1].charAt(0) ? l.protocol + "//" + window.location.host + a[1] : a[1], e.ua = s)
            }, _trackOrder: function (b) {
                b = b[1];
                d.d(b, "Object") && (a(b), e.f |= 16, h.a.b.nv = 0, h.a.b.st = 4, h.a.b.et = 94, h.a.b.ep = f.stringify(b), h.a.h())
                ...
                b = b[1];
                d.d(b, "Object") && (a(b), b = f.stringify(b),
                ...
                if (d.d(b, "Object")) {
                    ...
                    if (900 >= m) g.call(this, b); else for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * l.da).toString(16) + "|" + m + "|", n = [], v = 0; v < m; v++) n.push(v), n.push(b.substring(900 * v, 900 * v + 900)), g.call(this, q + n.join("|")), n = []
                }
                ...
                if (1 < a.length && (a = a[1], u === a || s === a)) h.a.ra = a
    ...
    (function () {
        function b() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.b = {}, this.ra = this.qa = s, this.D = k.D, this.na = g.aa() && 0 < c.aet.length ? c.aet.split(",") : "", this.$ = u, this.init())
        }

        var a = mt.url, d = mt.xa, f = mt.ha, g = mt.lang, l = mt.cookie, n = mt.g, p = mt.localStorage,
            e = mt.sessionStorage, k = h.p, w = h.A;
        b.prototype = {
            ba: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                if (!document.referrer) return k.m - k.w > c.vdur ? 1 : 4;
                var b = u;
                this.L(document.referrer) && this.L(document.location.href) ? b = s : (b = a.Y(document.referrer), b = this.ba(b || "", document.location.hostname));
                return b ? k.m - k.w > c.vdur ? 1 : 4 : 3
            }, getData: function (a) {
                try {
                    return l.get(a) || e.get(a) || p.get(a)
                } catch (b) {
                }
            }, setData: function (a, b, d) {
                try {
                    l.set(a, b, {domain: this.W(), path: this.pa(), V: d}), d ? p.set(a, b, d) : e.set(a, b)
                } catch (f) {
                }
            }, hb: function (a) {
                try {
                    l.set(a, "", {domain: this.W(), path: this.pa(), V: -1}),
                ...
                if (0 === c.nv && this.L(document.location.href) && ("" === document.referrer || this.L(document.referrer))) a = 0, b = 4;
                this.b.nv = a;
                this.b.st = b;
                this.b.cc = d;
                this.b.lt = e;
                ...
                for (var a = [], b = this.b.et, d = +new Date, e = 0, f = k.ya.length; e < f; e++) {
                    var g = k.ya[e], l = this.b[g];
                ...
                this.b.cm = a.k(b, k.$a) || "";
                this.b.cp = a.k(b, k.ab) || a.k(b, k.ub) || "";
                this.b.cw = a.k(b, k.Za) || a.k(b, k.wb) || "";
                this.b.ci = a.k(b, k.Xa) || a.k(b, k.tb) || "";
                this.b.cf = a.k(b, k.bb) || a.k(b, k.vb) || "";
                this.b.cu = a.k(b, k.Ya) || a.k(b, k.rb) || ""
            }, init: function () {
                try {
                    this.ob(),
                        0 === this.b.nv ? this.lb() : this.ga(".*"), h.a = this, this.Fa(), w.I("pv-b"), this.jb()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                this.qa ? (this.$ = s, this.b.et = 0, this.b.ep = "", this.b.vl = n.K() + n.B(), this.h(a)) : a();
                this.s = +new Date
            }, h: function (a) {
                if (this.ra) {
                    var b = this;
                ...
                var b = document.location.hash.substring(1), d = RegExp(c.id),
                    e = a.Y(document.referrer) === k.Ca ? 1 : 0, f = a.k(b, "jn"),
                    g = /^heatlink$|^select$|^pageclick$/.test(f);
                b && (d.test(b) && e && g) && (this.b.rnd = Math.round(Math.random() * k.da), b = document.createElement("script"), b.setAttribute("type", "text/javascript"), b.setAttribute("charset", "utf-8"), b.setAttribute("src", k.protocol +
                ...
                b && (a = encodeURIComponent(a.replace(/^https?:\/\//, "")), a = RegExp(a.replace(/([\*\(\)])/g, "\\$1") + "(%26u%3D[^,]*)?,?", "g"), (b = b.replace(a,
                    "").replace(/,$/, "")) ? e.set("Hm_unsent_" + c.id, b) : e.remove("Hm_unsent_" + c.id))
            }, lb: function () {
                var a = this, b = e.get("Hm_unsent_" + c.id);
                if (b) for (var b = b.split(","), f = function (b) {
                    d.log(k.ca + "//" + decodeURIComponent(b), function (b) {
                        a.ga(b)
                    })
    ...
    (function () {
        var b = mt.event, a = mt.lang, d = h.p;
        if (c.kbtrk && "undefined" !== typeof h.a) {
            h.a.b.kb = a.ta(h.a.b.kb) ? h.a.b.kb : 0;
            var f = function () {
                h.a.b.et = 85;
                h.a.b.ep = h.a.b.kb;
                h.a.h()
    ...
    (function () {
        var b = mt.g, a = mt.lang, d = mt.event, f = mt.l;
        if ("undefined" !== typeof h.a && (c.med || (!b.sa || 7 < b.cb) && c.cvcc)) {
            var g, l, n, p, e = function (a) {
                if (a.item) {
                ...
                e.v = b;
                if (d) {
                    var k = d.getAttribute("href"), l = d.getAttribute("onclick") ? "" + d.getAttribute("onclick") : t,
                        m = d.getAttribute("id") || "";
                    n.test(k) ? (e.sn = "mediate",
                        e.snv = k) : a.d(l, "String") && n.test(l) && (e.sn = "wrap", e.snv = l);
                    e.id = m
                }
                h.a.b.et = 86;
                h.a.b.ep = f.stringify(e);
                h.a.h();
            ...
            if (c.med) l = "/zoosnet", g = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, p = {
                ...
                p = {
                    click: function () {
                        for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, g, k = 0, l = b.length; k < l; k++) d = b[k], n !== r ? (f = d.getAttribute("onclick"), g = d.getAttribute("href"), m ? (d = d.getAttribute("id"), (n.test(f) || n.test(g) || m.test(d)) &&
                        a.push(b[k])) : (n.test(f) || n.test(g)) && a.push(b[k])) : m !== r && (d = d.getAttribute("id"), m.test(d) && a.push(b[k]));
                        return a
                    }
                }
            }
    ...
    (function () {
        var b = mt.e, a = mt.lang, d = mt.event, f = mt.l;
        if ("undefined" !== typeof h.a && a.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                za: function () {
                    for (var a = c.cvcf.length, f, p = 0; p < a; p++) (f = b.Na(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.Ja())
                }, Ja: function () {
                    return function () {
                        h.a.b.et = 86;
                        var a = {n: "form", t: "clk"};
                        a.id = this.id;
                        h.a.b.ep = f.stringify(a);
                        h.a.h()
                    }
                }
            };
