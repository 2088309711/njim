...
CREATE TABLE `im_corpus_data` (
  ...
  `access` varchar(20) NOT NULL DEFAULT '' COMMENT '实例标志',
  `title` text NOT NULL COMMENT '匹配内容',
  `content` text NOT NULL COMMENT '回复内容',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='语库组';
...
CREATE TABLE `im_corpus_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='语库组';
...
INSERT INTO `im_corpus_group` VALUES (1,'1321',1546074612,1546074612,''),(2,'1561',1546074646,1546074646,''),(3,'zzz0000',1546075001,1546077522,'2088309711'),(4,'00223366',1546075324,1546077597,'2088309711'),(5,'发送到发送到',1546075328,1546075328,'2088309711'),(6,'1651000',1546075841,1546075841,'2088309711'),(7,'发送到发送到000',1546075852,1546075852,'2088309711'),(8,'191',1546077095,1546077095,'2088309711');
...
CREATE TABLE `im_server_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=865 DEFAULT CHARSET=utf8 COMMENT='接入列表';
...
INSERT INTO `im_staff` VALUES (18,1,'11010101','',0,'2088309711','2088309711','f28fed86680bea284cf0cfe0640ec4',10,24,'userImg.jpg',1,0,1545991007,'01023130111...'),(37,1,'未设置','2088309711@qq.com',0,'12315611','12315611','35b393b97552275a93324129549294',10,0,'',1,1545555733,1545555733,'');
