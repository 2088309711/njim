 ...
 * 三大三小实例
 */
var vueThreeBigThreeSmall = new Vue({
    el: '#vue-three-big-three-small',
    data: {
        result: [
            // {
    ...
    methods: {
        ...
        compute: function (index, name, num, add, max, method) {
          ...
          <ul class="tab-nav">
            ...
            //单
            if (
                is_single(vueData.trs[0].nums[index]) &&
            ...
            if (
                is_double(vueData.trs[0].nums[index]) &&
                is_single(vueData.trs[1].nums[index]) &&
                is_single(vueData.trs[2].nums[index]) &&
            ...
            if (index < 5) {//龙虎
                ...
                //龙
                if (
                    is_loong(vueData.trs[0].nums, index) &&
                ...
                if (
                    is_tiger(vueData.trs[0].nums, index) &&
                    is_loong(vueData.trs[1].nums, index) &&
                    is_loong(vueData.trs[2].nums, index) &&
