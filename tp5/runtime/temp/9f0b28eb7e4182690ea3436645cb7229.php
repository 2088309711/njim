<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"F:\phpStudy\WWW\njim/tp5/application/client\view\index\index.html";i:1542876260;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
...
<div id="on-line-staff" class="container">
    ...
    <!--
        <li class="left">
            <div class="arrow"></div>
            <div class="time">00:06:08</div>
            <div class="bubble">客服</div>
            <div class="clear"></div>
        </li>
        <li class="right">
            <div class="arrow"></div>
            <div class="time">00:06:08</div>
            <div class="bubble">客户</div>
            <div class="clear"></div>
        </li>
        <li class="system"><span class="bubble">系统消息</span></li>
    -->
    <!-- 消息显示区 -->
