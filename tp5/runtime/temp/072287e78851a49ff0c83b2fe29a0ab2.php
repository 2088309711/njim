<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\phpStudy\WWW\njim/tp5/application/staff\view\login\index.html";i:1545267024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form action="/index.php/staff/login/loginCheck" method="post" class="am-form tpl-form-line-form">
                <?php echo token(); ?>
                <div class="am-form-group">
                    <input type="text" class="tpl-form-input" id="user-name" name="user_name" placeholder="请输入账号">
                </div>
                ...
                <div class="am-form-group am-text-right">
                    <a href="/index.php/staff/register">注册</a> | <a href="#">忘记密码</a>
                </div>
