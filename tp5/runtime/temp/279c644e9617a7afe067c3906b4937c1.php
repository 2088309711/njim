<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\php-workspace\njim/tp5/application/staff\view\register\index.html";i:1545230042;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form action="/index.php/staff/register/save" method="post" class="am-form tpl-form-line-form">
                <?php echo token(); ?>
                ...
                <div class="am-form-group">
                    <input type="text" class="tpl-form-input" id="user-name" name="user_name" placeholder="用户名">
                </div>
                ...
                <div class="am-form-group">
                    <input type="password" class="tpl-form-input" id="repassword" name="repassword"
                           placeholder="再次输入密码">
                </div>

                <div class="am-form-group tpl-login-remember-me">
                    <input id="agreement" name="agreement" value="1" type="checkbox">
                    <label for="agreement">
