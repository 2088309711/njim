<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\php-workspace\njim/tp5/application/client\view\index\phone_1.html";i:1544861523;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/static/css/phone_1.css">
...
<ul id="show-message" class="msg-box">
    <template v-for="item in messages"> <!-- 客服 -->
        <template
                v-if="item.type==1">
...
<div class="bottom">
    <div class="tool-bar">
        <!-- 表情 -->
        <div id="open-emo-panel" class="tool-icon"></div>
    </div>
    <div class="input">
        <textarea id="edit"></textarea>
        <button id="send">发送</button>
    </div>
    <div class="info">客服软件由柠吉IM免费提供</div>
</div>
...
<script src="/static/js/client_phone.js"></script>
</body>
</html>